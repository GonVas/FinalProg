...
void VendeMaisMais::recommendfor(string name)
{
	...
	else
	{
		...
		{
			if (i == 0)
				interesult = intersection(common1.pos_strings[0], common1.pos_strings[1] );
			else
				interesult = intersection(interesult, common1.pos_strings[i+1]);
		}
		...
		{
			cout << " Client should buy: " << interesult[0] << endl;
			return;
		}
	}
